...
points=detectSURFFeatures(I,'MetricThreshold',10,'NumOctaves',3, 'NumScaleLevels',6);
points1=detectSURFFeatures(I1,'MetricThreshold',10,'NumOctaves',3, 'NumScaleLevels',6);
